                ...
                <div className="row">
                  <div className="col-12 col-md-6 text-left" id="leftContent">
                    ...
                    <div className="title-desc">
                      ...
                      <h4 className="anim-2">Chào mừng bạn đã đến với Sutygon – dẫn đầu về tổ chức
                        sự kiện và cho thuê áo
                ...
                <div className="row">
                  <div className="col-md-6 col-sm-12">
                    <div className="title-desc anim-3">
                      <p className="text-left">SUTYGON được thành lập bởi một đội ngũ chuyên nghiệp
                        để mang đến những mặc
                        hàng chất lượng tuyệt đối, giá cả phải chăng, và trải nghiệm đầy ngọt
                        ngào. </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-5 col-sm-12">
                    <div className="embed-responsive embed-responsive-16by9" id="sizingVideo">
                      <iframe title={"video link"} width="660"
                              src="https://www.youtube.com/embed/Ui02o1wDvVk" frameBorder="0"
                        ...
                        <div className="card-body">
                          <div className="product-detail">
                            <div>
                              ...
                              <h4 id="headingBreak"><span
                                className="fas fa-qrcode"> 0123456</span><br/><span
                      ...
                      <div className="modal-dialog modal-xl" role="document">
                        <div className="modal-content">
                          <img className="img-fluid"
                               src="assets/img/items/img-people1-square.jpg" alt={""}/>
                          <button type="button" className="close" data-dismiss="modal"
                                  aria-label="Close" id="modalbtn">
