...
import { sectionProduct, sectionHome } from "../Functions/func";
import "../../../index.css";
import "../../../main.css";
...
const About = () => {
  ...
  const scrollFunc = () =>{
    var scrollDiv = document.getElementById("product").offsetTop;
  ...
  return (
    <div>
      ...
      <section
        ...
        id="about"
      >
        <div className="section sectionAbout section-description fp-auto-height-responsive">
          <div
            className="section-wrapper center-vh dir-col anim"
            style={{ color: "white" }}
          >
                ...
                <div className="col-md-6 col-sm-12">
                  <div className="title-desc anim-3">
                    <p className="text-left">
                      ...
                      mang đến những mặc hàng chất lượng tuyệt đối, giá cả phải
                      chăng, và trải nghiệm đầy ngọt ngào.{" "}
                    </p>
                  </div>
                </div>
